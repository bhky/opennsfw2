...
def validate_url(url: str) -> None:
    ...
    try:
        ...
        raise InvalidInputError(f"Invalid URL format: {e}") from e
...
def validate_base64(data: str) -> None:
    ...
    try:
        ...
        raise InvalidInputError(f"Invalid base64 format: {e}") from e
...
def validate_input_list(inputs: List[InputData]) -> None:
    ...
    for i, input_data in enumerate(inputs):
        try:
            ...
            raise InvalidInputError(f"Input {i+1}: {e}") from e
